...
<div id="top">
	<div class="header">
		...
		<h2>订单结算</h2>
		<a href="<?php echo site_url('qingqu/home/index');?>" class="b_r">继续购物</a>
	</div>
</div>
<div class="pageauto">
    ...
    <form action="<?php echo site_url('qingqu/home/buyok');?>" method="POST" id="car" class="se_p" onSubmit="return carb()">
		<div class="bgw pd10">
