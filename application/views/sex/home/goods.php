...
<div id="top goods-header">
	<div class="header hfix">
		...
		<a href="<?php echo site_url('qingqu/home/cart');?>" class="b_r dcar"></a>
	...
	<div class="content" id="goods">
		...
		<form action="car.php" id="buy" method="POST">
			...
			<div id="nok" class="lr10">
				<a href="<?php echo site_url('qingqu/home/cart')?>" class="lbtn left">加入购物车</a>
				<a href="<?php echo site_url('qingqu/home/buy')?>" class="rbtn right" id="buyn">立即购买</a>
				<div class="clear"></div>
			</div>
		</form>
		<div class="gbgw mt10">
