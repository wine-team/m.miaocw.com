...
<div class="pageauto login-reg" id="lbefore">
	<form action="<?php echo site_url('home/login')?>" method="post" class="login" id="login" onSubmit="return login();">
		...
		<a href="<?php echo site_url('home/reg')?>" class="h left">免费注册（送10元优惠券）</a>
		<a href="<?php echo site_url('home/forget')?>" style="color:#09F" class="right">忘记密码?</a>
		<div class="clear"></div>
