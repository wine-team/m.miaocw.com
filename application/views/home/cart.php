...
<div id="top">
	<div class="header">
		...
		<h2>购物车</h2>
		<a href="<?php echo site_url('home/buy');?>" class="b_r">去结算</a>
	</div>
</div>
<div class="pageauto">
	...
	<div class="ov" id="gm">     
		...
		<dl class="car">
			...
			<dd>
				<h3><a href="<?php echo site_url('home/goods');?>">香港雷霆Leten活塞X-9第三代全自动飞机杯</a></h3>
				<p class="left">
	...
	<div class="bgw pd10 mt10">
		...
		<p class="bline"></p>
		<a href="<?php echo site_url('home/index');?>" class="lbtn left">继续购物</a>
		<a href="<?php echo site_url('home/buy');?>" class="rbtn right">
			<p class="nxl">去结算</p>
		</a>
		<div class="clear"></div>
	</div>
