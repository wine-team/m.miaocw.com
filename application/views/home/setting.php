...
<div class="pageauto">
	<div style="min-height:400px;">
		<ul class="bul mb10">
			<li><a href="<?php echo site_url('home/address');?>">收货地址</a></li>
			<li><a href="<?php echo site_url('home/profile');?>">个人资料</a></li>
			<li><a href="<?php echo site_url('home/password');?>">修改密码</a></li>
		</ul>
	</div>
</div>
