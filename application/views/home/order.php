...
<div class="pageauto">
	<ul class="uorder mt10">
		<li>
			<a href="<?php echo site_url('home/orderdetail');?>"  class="arr">
			...
			<p class="btline">
				<a href="<?php echo site_url('home/orderdetail');?>" class="bun">详情</a>
			</p>
		</li>
		<li>
			<a href="<?php echo site_url('home/orderdetail');?>"  class="arr"><img src="http://s.qw.cc/images/201604/thumb_img/5415_thumb_P220_1460455530090.jpg" class="omg"/>
