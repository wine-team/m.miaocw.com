...
<select id="province_id" class="required select left" required="required" name="province_id" >
...
<select id="city_id" class="required select left" required="required" name="city_id" >
    <option value="">城市</option>
</select>

<select id="district_id" class="required select left" required="required" name="district_id" >
