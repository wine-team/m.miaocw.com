<div class="fot">
	<ul class="nav">
		<li>
			<a href="<?php echo site_url('home/index');?>" class="na">首页</a>
			<a href="<?php echo site_url('home/category');?>" class="na">分类</a>
			<a href="<?php echo site_url('home/car')?>" class="na">购物车</a>
	...
	<div class="lh25 mt10">
		<a href="<?php echo site_url('home/help')?>">帮助</a> | 
		<a href="<?php echo site_url('home/message');?>">反馈</a> | 
		<a href="<?php echo site_url('home/about');?>">关于我们</a>
	</div>
</div>
